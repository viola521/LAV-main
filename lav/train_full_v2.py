...
def main(args):
    ...
    lav = LAV(args)
    data_loader = get_data_loader('temporal_lidar_painted' if lav.point_painting else 'lidar', args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config-path', default='/home/violayu/disk2/LAV-main/config_v2.yaml')
